...
_t 'Copyright (C) 2022,2023- mirage335
See the end of the file for license conditions.
See license.txt for coreoracle license conditions.


Limited subset of coreoracle reference implementation functions which can be compabtible and useful from an MSW host. 

Do NOT interact with other functionality from an MSW host. Do NOT use the full coreoracle reference implementation functonality from an MSW host.'
...
_page
_heading1 'Safety'
_t 'You have been warned. Your accident is your accident.'
