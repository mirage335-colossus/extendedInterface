...
export ub_setScriptChecksum_contents='1068524215'
...
_main() {
	_embedFile-comments-bash "$scriptAbsoluteFolder"/../../gpl-3.0.txt "$scriptAbsoluteFolder"/gpl-3.0.txt
	
	_embedFile-comments-bash "$scriptAbsoluteFolder"/../../license.txt "$scriptAbsoluteFolder"/license.txt
	
	_embedFile-comments-bash "$scriptAbsoluteFolder"/../../WARNING_cryptography_willBeREPORTED_and_publicNOTICES.txt "$scriptAbsoluteFolder"/WARNING_cryptography_willBeREPORTED_and_publicNOTICES.txt
}
