...
@echo on
@echo **
CALL "C:\bin\mswadminpriv.bat" cmd.exe /C copy /Y "C:\core\infrastructure\extendedInterface\app\PimaxExperience\hook\hook.exe" "C:\Program Files\Pimax\PVRHome\PVRHome.exe"
@echo off
timeout 3
