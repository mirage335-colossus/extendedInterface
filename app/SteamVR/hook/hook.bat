...
REM ATTENTION: Disable if desktop overlays are to be started by voice command.
REM 015-VoiceAttack - AS ADMIN - SHELL-MSW - construct desk
cd "C:\Program Files (x86)\VoiceAttack"
CALL "C:\bin\mswadminpriv.bat" cmd.exe /C start /MIN /D "C:\Program Files (x86)\VoiceAttack" "" "C:\Program Files (x86)\VoiceAttack\VoiceAttack.exe" -profile "SHELL-MSW" -command "construct desk"
